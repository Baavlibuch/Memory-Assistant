...
public class RandomWords extends Disciplines {
...
//            (findViewById(R.id.progress_bar)).setVisibility(View.VISIBLE);
        ...
        protected void onPostExecute(String s) {
            ...
            setButtons();
            ((EditText) findViewById(R.id.no_of_values)).setHint(getString(R.string.enter) + " " + getString(R.string.words));
            RandomWords.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        }
    }
